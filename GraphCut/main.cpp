...
void GCApplication::showImage() const
{
	...
	for (it = prBgdPxls.begin(); it != prBgdPxls.end(); ++it)
		circle(res, *it, radius, LIGHT_BLUE, thickness);
...
int main(int argc, char** argv)
{
	...
	//const std::string filename = "C:\\Users\\Administrator\\Documents\\Visual Studio 2015\\Projects\\BingObjectnessCVPR14\\BingObjectnessCVPR14\\captureOcclusionVideo\\occlusion_video_11\\_add_border_40_1.jpg";
	CStr filename = "test.jpg";
	//const std::string filename = "G:\\resources\\videos\\foot_bridge_next_pa\\1.jpg";
	//string filename = "c:/resources/4000.jpg";
	Mat image = imread(filename, 1);
	if (image.cols >= 2048) {
		cv::Size sz;
		const float fScale = 3.0;
		sz.width = image.cols / fScale;
		sz.height = image.rows / fScale;
